	...
	public static String decodeUTF8(String input) {
		try{
			if(input==null)
	            ...
	            System.out.println(new String(input.getBytes("8859_1"),"euc-kr"));
	            ...
	            System.out.println(new String(input.getBytes("utf-8"),"euc-kr"));
	            ...
	            System.out.println(new String(input.getBytes("iso-2022-kr"),"euc-kr"));
	            ...
	            System.out.println(new String(input.getBytes("KSC5601"),"euc-kr"));
	            System.out.println(new String(input.getBytes("euc-kr"),"iso-2022-kr"));
	            System.out.println(new String(input.getBytes("euc-kr"),"utf-8"));
	            System.out.println(new String(input.getBytes("euc-kr"),"8859_1"));
	            System.out.println(new String(input.getBytes("euc-kr"),"KSC5601"));*/	            
...
//			System.out.println(e);
	...
	public static String formatNum(String numStr) {
		try {
	    	...
	    	//ErrorLog.log("formatNum Exception : " + e.toString());
	    }
    	return numStr;
	}
...
//			System.out.println("method with given name & param types not found : " + e);
		} catch (InvocationTargetException e) {
//			System.out.println("exception occured while invoking method : " + e);
		} catch (ClassNotFoundException e) {
//			System.out.println("java.lang.String not found");
		} catch (IllegalAccessException e) {
//			System.out.println("Can not access private or protected variables");
		}
	}
...
//			System.out.println("ProofHandler.convertNumToKr Method Exception : "+e.getMessage());
